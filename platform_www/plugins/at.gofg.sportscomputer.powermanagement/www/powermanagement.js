...
PowerManagement.prototype.dimWithExpireTime = function(time, successCallback, failureCallback ) {
    cordova.exec(successCallback, failureCallback, 'PowerManagement', 'acquireWithExpireTime', [time] );
}
